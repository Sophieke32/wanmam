...
public class WANMAM {
    ...
    // Creates a creative tab with the id "wanmam:example_tab" for the example item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.wanmam")) //The language key for the title of your CreativeModeTab
    ...
    public WANMAM(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (WANMAM) to respond directly to events.
